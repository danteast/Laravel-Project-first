...
Route::get('firstpage/', [\App\Http\Controllers\CatController::class, 'index']);
Route::get('backform/', [\App\Http\Controllers\CatController::class, 'backform']);
Route::get('news/', [\App\Http\Controllers\CatController::class, 'catList'])->name('news');
Route::get('news/{id}', [\App\Http\Controllers\NewsController::class, 'newsList'])->where('id', '\d+');
